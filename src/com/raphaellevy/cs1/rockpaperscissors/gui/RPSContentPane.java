...
public class RPSContentPane extends JPanel {
	public RPSContentPane(RPSFrame frame) {
		super();
	...
	public void paintComponent(Graphics g) {
		...
		g.drawImage(new ImageIcon(RockPaperScissors.class.getResource("/assets/backgroundimage.png")).getImage(), 0, 0,
				RPSFrame.WINDOW_WIDTH, RPSFrame.WINDOW_HEIGHT, null);
	}
}
